...
namespace ZMQ {
    ...
    public struct Message {
        ...
        public Message.with_size (size_t size);

        [CCode (cname = "zmq_msg_init_data")]
        public Message.with_data (owned uint8[] data, free_fn? ffn = GLib.free);
        ...
        public int move (ref Message dest);

        [CCode (cname = "zmq_msg_copy", instance_pos = -1)]
        private int _copy (ref Message dest);
        ...
        public Message clone () {
            ...
            Message copy = Message.with_data (data);
            return copy;
        }
    ...
    public class Socket {
        ...
        public int setsockopt (SocketOption option, void* optval, size_t optvallen);

        public int getsockopt (SocketOption option, void* optval, ref size_t optvallen);
        ...
        public int sendmsg (ref Message msg, SendRecvOption flags = 0);

        public int recvmsg (ref Message msg, SendRecvOption flags = 0);
    }

    [Flags]
    [CCode (cprefix = "ZMQ_POLL")]
